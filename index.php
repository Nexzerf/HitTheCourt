    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <div class="hero-image">
                <img src="images/hero.png" alt="Sports Court">
            </div>
        </div>
    </section>
    ...
    <section id="about" class="section">
        <div class="container">
            ...
            <p style="text-align: center; max-width: 800px; margin: 0 auto; color: var(--gray-500); font-size: 1.1rem;">
                ...
                friendly prices, on-site food and drinks, and sports equipment rentals. Designed for young 
                players who want to play hard, chill easy, and enjoy the game without limits.
            </p>
        </div>
    </section>
